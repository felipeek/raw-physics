...
typedef enum {
	DEBUG_EXAMPLE_SCENE,
	CUBE_AND_RAMP_EXAMPLE_SCENE,
	CUBE_STORM_EXAMPLE_SCENE,
	SEESAW_EXAMPLE_SCENE,
	SPRING_EXAMPLE_SCENE,
	BRICK_WALL_EXAMPLE_SCENE,
	MIRROR_CUBE_EXAMPLE_SCENE,
	HINGE_JOINTS_EXAMPLE_SCENE,
	ARM_EXAMPLE_SCENE,
	STACK_EXAMPLE_SCENE,
	ROTT_PENDULUM_EXAMPLE_SCENE,
	TRIPLE_PENDULA_EXAMPLE_SCENE,
	SPOT_STORM_EXAMPLE_SCENE,
	COIN_EXAMPLE_SCENE,
	END_EXAMPLE_SCENE
} Example_Scene_Type;

#define EXAMPLE_SCENE_INITIAL CUBE_AND_RAMP_EXAMPLE_SCENE
//#define EXAMPLE_SCENE_INITIAL DEBUG_EXAMPLE_SCENE
//#define EXAMPLE_SCENE_INITIAL SPRING_EXAMPLE_SCENE
